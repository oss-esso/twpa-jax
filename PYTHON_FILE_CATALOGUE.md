...
#### Current/Reworked Stack (1 files)

| File | Functionality / observed role | Top-level symbols |
|---|---|---|
| experiments/pump_basis.py | Python support/entry-point module | - |

#### Legacy/Historical/Auxiliary (114 files)

| File | Functionality / observed role | Top-level symbols |
|---|---|---|
| experiments/benchmark_exp08_pump_schur_matrixfree.py | Benchmark matrix-free / Schur pump-solver backends on the high-power fold | dbm_to_peak_current_a, BackendSpec, make_settings, GainEvaluator, ProblemFactory, solve_backend_point... |
| experiments/benchmark_exp08_pump_single_speedups.py | Module; defines safe_rmtree, run_cmd, load_json, final_pump_report, final_gain_report, rel_diff, as_float, run_variant and more | safe_rmtree, run_cmd, load_json, final_pump_report, final_gain_report, rel_diff... |
| experiments/benchmark_gpu_lu.py | Benchmark GPU sparse LU vs CPU Pardiso/SuperLU on the real-coupled matrix M | timeit, main |
| experiments/benchmark_jvp_device.py | Standalone CPU-vs-accelerator microbenchmark of the retained Schur AFT/JVP | dbm_to_peak_current_a, warm_solve_to, build_jax_jvp, main |
| experiments/benchmark_seven_designs_vs_jc.py | Native-Julia vs Python runtime table for the 7 JC doc designs | Row, _f, read_python_timings, run_jc_timing, build_rows, fmt... |
| experiments/build_scattered_ipm_design.py | Copy a 2c/3c IPM design and optionally add Josephson Lj scatter | _copytree_clean, _scatter_arrays, _zero_scatter_meta, _scatter_elements_csv, _update_summary, scatter_existing_design... |
| experiments/exp01_matrix_free_pump.py | Experiment 01: matrix-free nonlinear periodic pump solve | FourierTimeGrid, JosephsonBranch, PumpProblem, NewtonKrylovSettings, SolveReport, NewtonKrylovPumpSolver... |
| experiments/exp02_harmonic_coeff_pump.py | Experiment 02: harmonic-coefficient nonlinear pump solve | HarmonicGrid, JosephsonBranch, HarmonicPumpProblem, pack_complex, unpack_complex, NewtonKrylovSettings... |
| experiments/exp03_gain_from_pump.py | Experiment 03: gain/conversion solve from a converged pump | PumpStageResult, GainResult, solve_pump_stage, fourier_coeff_real_time, compute_gamma_hat_blocks, linear_dynamic_block... |
| experiments/exp04_known_parametric_gain_fixture.py | Experiment 04: known positive-gain parametric fixture | ParametricGainResult, safe_db, complex_sqrt, generator_matrix, analytic_transfer, expm_transfer... |
| experiments/exp05_known_gain_sideband_matrix.py | Experiment 05: known-gain fixture in Exp03-style sideband matrix form | safe_db, complex_sqrt, exp04_transfer, rho_from_target_transfer_amplitude, sideband_indices, SidebandGainResult... |
| experiments/exp06_synthetic_gamma_circuit_matrix.py | Experiment 06: synthetic Gamma(t) gain in Exp03-style circuit matrix | safe_db, complex_sqrt, exp04_transfer, rho_from_target_transfer_amplitude, SyntheticGammaGrid, build_khat_from_synthetic_gamma... |
| experiments/exp07_python_ipm_design_builder.py | Python support/entry-point module | - |
| experiments/exp08_full_ipm_pump_solve.py | Python support/entry-point module | - |
| experiments/exp09_full_ipm_gain_from_pump.py | Python support/entry-point module | - |
| experiments/exp10_full_ipm_pump_map_warmstart.py | Experiment 10: warm-started IPM pump/gain map with a cold-vs-warm gate | dbm_to_peak_current_a, signal_ghz_for, spectrum_offsets_mhz, finite_or_none, read_json, slug_float... |
| experiments/exp10_jc_doc_python_design_builders.py | Build Python matrix models for the 7 JosephsonCircuits.jl documentation examples: JPA, DPJPA, FXJPA, JTWPA, FQJTWPA, FQJTWPA_diss, FXJTWPA | ic_to_lj, safe_float_or_pair, Port, LinearInductor, MutualCoupling, JosephsonBranch... |
| experiments/exp10_pump_freq_sweep.py | Pump-frequency gain sweep at a fixed pump power (line plot) | dbm_to_peak_current_a, read_json, signal_ghz_for, run, solve_point, sweep_scale... |
| experiments/exp10_signal_sweep_at_pump.py | Signal-frequency gain profile at a fixed pump (line plot) | dbm_to_peak_current_a, run, read_sweep, sweep_scale, parse_args, read_python_series... |
| experiments/exp11_jc_doc_solver_probe.py | Run the current Python harmonic-pump/gain solver on the JosephsonCircuits.jl documentation designs exported by exp10_jc_doc_python_design_builders.py | run, grab_float, grab_str, help_text, require_args, load_json... |
| experiments/exp12_dc_operating_point_probe.py | Python support/entry-point module | - |
| experiments/exp12_dpjpa_two_pump_gain_probe.py | Python support/entry-point module | - |
| experiments/exp12_dpjpa_two_pump_probe.py | Python support/entry-point module | - |
| experiments/exp13_compare_gain_curves.py | Python support/entry-point module | - |
| experiments/exp13_compare_python_H5_to_jc_npump.py | Python support/entry-point module | - |
| experiments/exp13_compare_python_jc_gamma_hat_summary.py | Python support/entry-point module | - |
| experiments/exp13_jc_source_search.py | Python support/entry-point module | - |
| experiments/exp13_jpa_convention_probe.py | Python support/entry-point module | - |
| experiments/exp13_jpa_observable_calibration.py | Python support/entry-point module | - |
| experiments/exp13_jpa_pump_scale_ladder.py | Python support/entry-point module | - |
| experiments/exp13_jtwpa_diagonly_scale_compare.py | Python support/entry-point module | - |
| experiments/exp13_jtwpa_fast_scale2.py | Python support/entry-point module | - |
| experiments/exp13_jtwpa_fast_scale_ladder.py | Python support/entry-point module | - |
| experiments/exp13_jtwpa_harmonic_ladder.py | Python support/entry-point module | - |
| experiments/exp13_jtwpa_jc_mode_list_probe.py | Python support/entry-point module | - |
| experiments/exp13_jtwpa_offdiag_coupling_ladder.py | Python support/entry-point module | - |
| experiments/exp13_plot_jtwpa_fast_21pt.py | Python support/entry-point module | - |
| experiments/exp13_plot_jtwpa_passive_parity.py | Python support/entry-point module | - |
| experiments/exp13_python_gamma_hat_dump.py | Python support/entry-point module | - |
| experiments/exp13_run_other6_python_scale2.py | Python support/entry-point module | - |
| experiments/exp13_run_other6_python_scale2_stream.py | Python support/entry-point module | - |
| experiments/exp14_build_jc_warmstart.py | Convert a JC nonlinear pump nodeflux dump into a Python warm-start seed | main |
| experiments/exp14_diss_gamma_nt_check.py | Python support/entry-point module | - |
| experiments/exp14_diss_linearization_probe.py | Python support/entry-point module | - |
| experiments/exp14_diss_loss_study.py | Loss-convention study for jc_fqjtwpa_diss | load_curve, main |
| experiments/exp14_diss_pump_state_scale_probe.py | Python support/entry-point module | - |
| experiments/exp14_dpjpa_multitone.py | Two-tone (multi-pump) harmonic balance pump solve + reflection gain for DPJPA | load_design, positive_half_lattice, full_box, omega_of, dynamic_block, Torus... |
| experiments/exp14_extract_exp09_core_snippets.py | Python support/entry-point module | - |
| experiments/exp14_fxjtwpa_K_variant_linear_residual_probe.py | Python support/entry-point module | - |
| experiments/exp14_fxjtwpa_K_variant_residual_probe.py | Python support/entry-point module | - |
| experiments/exp14_fxjtwpa_compare_all_gain_columns.py | Python support/entry-point module | - |
| experiments/exp14_fxjtwpa_compare_pump_solved_gain.py | Python support/entry-point module | - |
| experiments/exp14_fxjtwpa_fix_seed.py | Write a node-order-corrected fxjtwpa JC seed (pump X + DC) for exp09 | build_perm, main |
| experiments/exp14_fxjtwpa_idler_convention_scan.py | Python support/entry-point module | - |
| experiments/exp14_fxjtwpa_inventory.py | Python support/entry-point module | - |
| experiments/exp14_fxjtwpa_make_K_variants.py | Python support/entry-point module | - |
| experiments/exp14_fxjtwpa_make_K_variants_v2.py | Python support/entry-point module | - |
| experiments/exp14_fxjtwpa_node_mapping_diagnostic.py | Python support/entry-point module | - |
| experiments/exp14_fxjtwpa_node_perm_test.py | Test the node-ordering hypothesis for the fxjtwpa JC seed | residual_l2, main |
| experiments/exp14_fxjtwpa_residual_decomp.py | Decompose the JC-seed pump residual for fxjtwpa into its three physical parts | main |
| experiments/exp14_fxjtwpa_seed_artifact_manifest.py | Python support/entry-point module | - |
| experiments/exp14_fxjtwpa_seed_validate.py | Rigorously test whether the JC-seed pump residual (~45) is roundoff or real, and report the physical pump phase swing | main |
| experiments/exp14_fxjtwpa_seed_vs_solved_compare.py | Python support/entry-point module | - |
| experiments/exp14_fxjtwpa_sideband_scan.py | Python support/entry-point module | - |
| experiments/exp14_fxjtwpa_structural_probe.py | Python support/entry-point module | - |
| experiments/exp14_inventory_diss_gain_reports.py | Python support/entry-point module | - |
| experiments/exp14_seven_design_summary.py | Build the 7-design JC parity summary table for the pump-mode-policy work | CaseSpec, load_curve, peak_of, finite_float, rounded, sum_report_field... |
| experiments/exp14_source_map_loss_sites.py | Python support/entry-point module | - |
| experiments/exp16_ipm_gain_map.py | Experiment 16: IPM pump-power / pump-frequency gain map | dbm_to_watts, old_ipm_peak_current_from_external_dbm, slug_float, load_json, run_command, signal_ghz_for... |
| experiments/exp17_ripple_map_compare.py | Experiment 17c: compare a map cell's operating point three ways | parse_args, load_top_cells, _sweeps_from_pump, cold_variant, map_warm_variant, main |
| experiments/exp17_ripple_map_crosscheck.py | Experiment 17b: cross-check an IPM gain map against the S42 ripple | parse_args, load_map_pool, passive_peaks, verify_cell, main |
| experiments/exp17_ripple_pump_placement.py | Experiment 17: S42-ripple pump placement for the IPM JTWPA (2c/3c) | parse_args, compute_passive, characterize_point, main |
| experiments/exp18_signal_spectrum_cell_timing.py | Python support/entry-point module | - |
| experiments/extract_jc_jpa_builder_and_adapter.py | Python support/entry-point module | - |
| experiments/inspect_exp09_rhs_and_matrix.py | Python support/entry-point module | - |
| experiments/inspect_python_design_port_data_abs.py | Python support/entry-point module | - |
| experiments/patch_exp08_dc_support.py | Python support/entry-point module | - |
| experiments/patch_exp08_dc_support_v2.py | Python support/entry-point module | - |
| experiments/patch_exp08_dc_support_v3.py | Python support/entry-point module | - |
| experiments/patch_exp08_secant_predictor.py | Python support/entry-point module | - |
| experiments/patch_exp08_spectral_jvp.py | Python support/entry-point module | - |
| experiments/patch_exp08_spectral_jvp_v2.py | Python support/entry-point module | - |
| experiments/patch_exp08_tangent_cache.py | Python support/entry-point module | - |
| experiments/patch_exp09_actual_scope_fix.py | Python support/entry-point module | - |
| experiments/patch_exp09_dc_support.py | Python support/entry-point module | - |
| experiments/patch_exp09_fix_args_scope.py | Python support/entry-point module | - |
| experiments/patch_exp09_fix_literal_newline_bug.py | Python support/entry-point module | - |
| experiments/patch_exp09_ipm_dir.py | Python support/entry-point module | - |
| experiments/patch_exp09_jc_style_gain.py | Python support/entry-point module | - |
| experiments/patch_exp09_jc_style_gain_v2.py | Python support/entry-point module | - |
| experiments/patch_exp09_jc_style_gain_v3.py | Python support/entry-point module | - |
| experiments/patch_exp10_lj_nameerror_fix.py | Python support/entry-point module | - |
| experiments/patch_exp10_lj_schema_fix.py | Python support/entry-point module | - |
| experiments/patch_exp10_phi0_shape_fix.py | Python support/entry-point module | - |
| experiments/patch_exp10_schema_fix.py | Python support/entry-point module | - |
| experiments/patch_exp11_aft_quiet_fix.py | Python support/entry-point module | - |
| experiments/patch_exp11_diss_default_cases_fix.py | Python support/entry-point module | - |
| experiments/patch_exp11_enable_fqjtwpa_diss.py | Python support/entry-point module | - |
| experiments/patch_exp11_enable_fqjtwpa_diss_clean.py | Python support/entry-point module | - |
| experiments/patch_exp11_fqjtwpa_diss_manual_config.py | Python support/entry-point module | - |
| experiments/patch_exp11_gain_ipm_dir.py | Python support/entry-point module | - |
| experiments/patch_exp11_gain_ipm_dir_clean_fix.py | Python support/entry-point module | - |
| experiments/patch_exp11_gain_ipm_dir_v2.py | Python support/entry-point module | - |
| experiments/plot_exp10_gain_map.py | Plot exp10 warm-start gain maps (gain in dB over pump power x pump frequency) | edges_from_centers, signal_label, plot_grid, _valid_savgol_window, spectrum_peak_grid, write_spectrum_peak_cache... |
| experiments/plot_ripple_pump_placement.py | Plot the S42-ripple pump-placement workflow (twpa_jax port) | read_sweep, plot_point, plot_compare_point, main |
| experiments/profile_exp10_highpower_solve.py | Profile what makes high-power pump solves slow | main |
| experiments/pump_solvers/__init__.py | Experimental, GPU-compatible / matrix-free pump-solver backends | - |
| experiments/pump_solvers/fast_coupled.py | Fast exact real-coupled preconditioner: assembly + symbolic-factorization reuse | pardiso_available, _KhatDataMap, _env_true, _log_factor_backend_once, _pardiso_thread_context, FastCoupledPreconditioner |
| experiments/pump_solvers/jvp_backends.py | JVP backends and a finite-difference sanity check | jax_available, analytic_jvp, fd_jvp, jvp_relative_error |
| experiments/pump_solvers/schur_operators.py | Schur-reduced pump problem: a drop-in for the full Newton-Krylov solver | SchurReducedProblem, build_schur_problem |
| experiments/pump_solvers/schur_partition.py | Node partition and per-harmonic Schur elimination for the pump solve | SchurPartition, build_partition, assemble_schur_complements, restrict, reduced_linear_apply, back_substitute_full |
| experiments/ripple_common.py | Shared helpers for the S42-ripple pump-placement workflow (twpa_jax port) | build_design, ic_reference_a, passive_s_matrix, db20, Placement, find_s42_peaks... |
| experiments/run_exp08_tolerance_ladder.py | Python support/entry-point module | - |
| experiments/study_realcoupled_matrix.py | Decomposability study of the real-coupled preconditioner matrix M at the fold | assemble_fold_matrix, hr, study, main |
### notebooks/
...
#### Current/Reworked Stack (8 files)

| File | Functionality / observed role | Top-level symbols |
|---|---|---|
| scripts/compare_gain_maps.py | Plot headline gain error maps between saved gain-map runs. | build_parser, load_gain_grid, plot_gain_error_map, _slug, main |
| scripts/debug_alternate_seed_probe.py | Phase A2 (docs/multistability_and_cli_trim_plan.md): direct empirical test for multistability at a Phase-A1-flagged discontinuity -- a cell where the column tra | make_point, load_retained_x, x_norm_diff, _print_row, write_summary, main |
| scripts/debug_cell_gmres_matrix_analysis.py | Cold vs warm GMRES/Jacobian analysis for one failing map cell | NewtonSnapshot, _capturing_refactor, _capturing_gmres_call, ResidualSnapshot, _capturing_residual_coeffs, install_hooks... |
| scripts/floquet_stability_sweep.py | Floquet stability sweep: Tier 1 (real-omega sigma_min) + Tier 2 (complex-omega refinement) | parse_args, _load_pump_and_khat, _run_sweep, main |
| scripts/plot_gain_map.py | Generate standard plots and tables from saved gain-map outputs. | PlotConfig, build_parser, infer_ipm_dir, _candidate_filename, _gain_candidates, _run_candidate_sweep... |
| scripts/prune_map_solutions.py | Prune a finished gain-map's per-point pump_solution.npz down to the cells the plotter would re-sweep | _subpath_under_map, keep_solution_paths, parse_args, main |
| scripts/run_gain_map.py | Experiment 10: warm-started IPM pump/gain map with a cold-vs-warm gate | dbm_to_peak_current_a, peak_current_to_power_dbm, attenuation_db_for, signal_ghz_for, spectrum_offsets_mhz, finite_or_none... |
| scripts/tune_lj_to_themis.py | Auto-tune the 2c design's Lj (and, once close, Cg) to close the pump-frequency shift against the Themis measurement | Point, build_design, run_gain_map, align_to_measurement, evaluate, write_log... |

#### Legacy/Historical/Auxiliary (98 files)

| File | Functionality / observed role | Top-level symbols |
|---|---|---|
| scripts/__init__.py | Package initializer/export module | - |
| scripts/align_map_to_measurement.py | Plot a Themis gain-map measurement and align a 2c simulation to it by shifts | load_measurement_map, load_sim_map, _roi_weights, _huber_rho, _score_shift, align_maps... |
| scripts/analyze_intracell_campaign.py | Compare intra-cell continuation maps and locate their first pump errors. | parse_args, load_run, first_error_rows, main |
...
| scripts/build_scattered_design.py | Python support/entry-point module | - |
| scripts/build_standalone_coupler.py | Build an isolated four-port coupler from an existing IPM design | parse_args, main |
| scripts/compare_campaign.py | Compare continuation-method campaign runs on coverage, cost, and gain | RunResult, _status_counts, load_run, snapshot, print_table, _grid_shape... |
| scripts/compare_map_to_measurement.py | Compare a simulated 2c gain map to the Themis 15 mK transmission measurement | load_measurement, collapse_power, load_sim, sim_boundary_power, sim_peak_gain, main |
| scripts/compression_sweep.py | Run a TWPA gain-compression sweep | RunStatus, PointSolverMode, CompressionSweepConfig, CompressionPointResult, PumpPreparationResult, CompressionSweepResult... |
| scripts/debug_branch_discontinuity_scan.py | Phase A1 (docs/multistability_and_cli_trim_plan.md): read-only scan of a finished map's map_points.csv for cells where a cold reseed (warm_retry_reseed =True, r | _parse_float, _parse_bool, load_map_points, group_by_column, scan_column, scan_map_dir... |
...
| scripts/debug_power_sweep_fine_continuation_methods.py | Zoom into where the cliff actually starts (right after P7), and check whether any of the 5 available intra-cell continuation methods changes the picture | build_points, main, write_summary, plot_coeff_rel |
| scripts/effective_cell_convergence.py | Study effective-cell convergence for a TWPA linear model | RunStatus, CoarseningMethod, EffectiveCellConvergenceConfig, StageResult, CoarsenedRunResult, EffectiveCellConvergenceResult... |
...
| scripts/measure_map_envelope_periodicity.py | Count diagonal high-gain/low-gain streak pairs in a 2-D gain map | envelope_over_power, resample_common_grid, periodicity_metrics, main |
| scripts/measure_pump_periodicity.py | Quantify pump-frequency comb periodicity for the measurement and sim maps | resample_common_grid, periodicity_metrics, main |
| scripts/overlay_sim_vs_measurement.py | Superimpose a run_gain_map sim map on the Themis measurement, same axes | main |
| scripts/periodicity_campaign.py | Isolate which IPM design parameter(s) drive pump-frequency fringe periodicity | build_design, run_map, peak_count, main |
| scripts/plot_gain_residual_aligned.py | Normalize measurement vs each sim to [-1,1], align on first peak, subtract | third_up_power, nearest_row, normalize_minmax, first_peak_freq, align_and_subtract, main |
| scripts/plot_gain_vs_freq_third_power.py | Plot gain vs pump frequency for measurement + N sim maps, each at its own power = min_power + (max_power - min_power) / 3, on one shared plot | third_up_power, nearest_row, main |
| scripts/plot_gain_vs_pumpfreq_signalfreq.py | Plot S21 gain (dB) vs pump frequency and signal frequency, fixed pump power | plot_one, main |
| scripts/plot_gain_vs_pumppower_signalfreq.py | Plot S21 gain (dB) vs pump power and signal frequency, fixed pump frequency | plot_one, main |
| scripts/plot_jc_old_ipm_gain_map_with_status.py | Python support/entry-point module | - |
| scripts/plot_lj_periodicity.py | Compare pump-frequency periodicity and optionally sweep the IPM Lj | load_measurement, load_simulation, matched_power_dbm, run_lj_sweep, plot_curves, main |
| scripts/plot_measurement_gain_vs_pumpfreq_signalfreq.py | Plot raw Themis transmission vs pump frequency and signal frequency, at the PumpPower row nearest a fixed target, using the per-pump-frequency .npy files | load_all, main |
...
| scripts/plot_passive_s21_s24.py | Compute and plot pump-off S-parameters for an IPM design | parse_args, main |
| scripts/plot_report_old_ipm_power_map.py | Python support/entry-point module | - |
...
| scripts/plot_s21_lj_cg_grid.py | Overlay pump-off S21 vs signal frequency for a grid of (Lj, Cg) designs | main |
...
| scripts/run_ipm_exp08_exp09_gain_map.py | Python support/entry-point module | - |
...
| scripts/scan_hdf5_pump_maps.py | Python support/entry-point module | - |
| scripts/synthetic_recovery.py | Run synthetic parameter-recovery experiments for the TWPA stack | RunStatus, SyntheticMode, FitMode, SyntheticRecoveryConfig, StageResult, RecoveryTrialResult... |
### src/

#### Current/Reworked Stack (38 files)

| File | Functionality / observed role | Top-level symbols |
|---|---|---|
| src/__init__.py | Package initializer/export module | - |
| src/twpa_solver/__init__.py | General harmonic-balance solver for Josephson circuits. | - |
| src/twpa_solver/builders/__init__.py | Circuit builders | - |
| src/twpa_solver/builders/ipm.py | Experiment 07: standalone Python IPM design builder | Element, CouplerGeometry, CouplerDiscrete, IPMParams, elliptical_integral, elliptical_integral_prime... |
| src/twpa_solver/builders/jc_doc.py | Build Python matrix models for the 7 JosephsonCircuits.jl documentation examples: JPA, DPJPA, FXJPA, JTWPA, FQJTWPA, FQJTWPA_diss, FXJTWPA | ic_to_lj, safe_float_or_pair, Port, LinearInductor, MutualCoupling, JosephsonBranch... |
| src/twpa_solver/builders/scattered.py | Copy a 2c/3c IPM design and optionally add Josephson Lj scatter | _copytree_clean, _scatter_arrays, _zero_scatter_meta, _scatter_elements_csv, _update_summary, scatter_existing_design... |
| src/twpa_solver/core/__init__.py | Package initializer/export module | - |
| src/twpa_solver/core/circuit.py | Module; defines CircuitMatrices, load_circuit, save_circuit | CircuitMatrices, load_circuit, save_circuit |
| src/twpa_solver/core/constants.py | Module; defines lj_to_ic, ic_to_lj | lj_to_ic, ic_to_lj |
| src/twpa_solver/core/linear.py | Module; defines dynamic_block, port_s_from_unit_current_response, LinearScatteringResult, solve_linear_scattering | dynamic_block, port_s_from_unit_current_response, LinearScatteringResult, solve_linear_scattering |
| src/twpa_solver/loss.py | Frequency-dependent insertion-loss model for pump/signal attenuation | InsertionLossModel, default_loss_model |
| src/twpa_solver/parity/__init__.py | Package initializer/export module | - |
| src/twpa_solver/plotting/__init__.py | Plotting and reporting helpers for saved TWPA gain-map runs. | - |
| src/twpa_solver/plotting/candidates.py | Candidate selection for fitted gain-map metrics. | PlotConfig, _is_converged_status, compute_all_fit_metrics, gain_ranked_candidates, _best_row, select_candidates... |
| src/twpa_solver/plotting/data.py | Load and normalize saved gain-map outputs. | MapData, _load_npz, _rename_first, _normalize_points, _first_array, _normalize_arrays... |
| src/twpa_solver/plotting/maps.py | Standard fitted gain-map plots. | _edges, _metric_grid, _plot_metric_map, _overlay_candidate_markers, _group_candidate_rows, plot_peak_gain_fit_map... |
| src/twpa_solver/plotting/metrics.py | Fit-based spectrum metrics for gain-map plotting. | SpectrumFitMetrics, SpectrumFit, auto_savgol_window, _finite_sorted_xy, fit_spectrum, dense_fit_curve... |
| src/twpa_solver/plotting/spectrum.py | Detailed candidate spectrum plots. | _fit_error, _symmetric_error_edges, plot_candidate_s21_bandwidth, plot_candidate_spectrum |
| src/twpa_solver/plotting/style.py | Shared plotting style helpers. | apply_thesis_style, save_figure |
| src/twpa_solver/pump/__init__.py | Package initializer/export module | - |
| src/twpa_solver/pump/backends/__init__.py | Package initializer/export module | - |
| src/twpa_solver/pump/backends/fast_coupled.py | Fast exact real-coupled preconditioner: assembly + symbolic-factorization reuse | pardiso_available, _KhatDataMap, _env_true, _log_factor_backend_once, _pardiso_thread_context, FastCoupledPreconditioner |
| src/twpa_solver/pump/backends/jvp_backends.py | JVP backends and a finite-difference sanity check | jax_available, analytic_jvp, fd_jvp, jvp_relative_error |
| src/twpa_solver/pump/backends/schur_operators.py | Schur-reduced pump problem: a drop-in for the full Newton-Krylov solver | SchurReducedProblem, build_schur_problem |
| src/twpa_solver/pump/backends/schur_partition.py | Node partition and per-harmonic Schur elimination for the pump solve | SchurPartition, build_partition, assemble_schur_complements, restrict, reduced_linear_apply, back_substitute_full |
| src/twpa_solver/pump/basis.py | Pump-mode basis policies shared by exp08 (pump solve) and exp09 (gain) | PumpBasis, positive_odd_modes, parse_explicit_modes, _unwrap_design_meta, _modes_from_design_meta, resolve_pump_basis... |
| src/twpa_solver/pump/hb.py | Python support/entry-point module | - |
| src/twpa_solver/pump/io.py | Module; defines summarize_solution, write_results | summarize_solution, write_results |
| src/twpa_solver/pump/predictors.py | Inter-cell state predictors for the pump/gain map warm pass | _shapes_match, copy_predictor, axis_secant, corner_predictor, plane_predictor, rank_candidates |
| src/twpa_solver/pump/problem.py | Module; defines HarmonicGrid, JosephsonBranchArray, pack_complex, unpack_complex, TangentState, SpectralTangentState, FullPumpProblem | HarmonicGrid, JosephsonBranchArray, pack_complex, unpack_complex, TangentState, SpectralTangentState... |
| src/twpa_solver/pump/seeds.py | Module; defines load_dc_solution, build_linear_phasor_seed | load_dc_solution, build_linear_phasor_seed |
| src/twpa_solver/pump/solver.py | Module; defines _real_dot, _finite_state, _finite_residual, GmresDeadlineExceeded, NewtonKrylovSettings, StepReport, ContinuationTrace, empty_continuation_trace | _real_dot, _finite_state, _finite_residual, GmresDeadlineExceeded, NewtonKrylovSettings, StepReport... |
| src/twpa_solver/signal/__init__.py | Package initializer/export module | - |
| src/twpa_solver/signal/floquet.py | Module; defines _pardiso_thread_context, _same_csr_pattern, _pardiso_spsolve_reuse, sideband_list, assemble_khat_conversion_base, assemble_conversion_matrix_fro | _pardiso_thread_context, _same_csr_pattern, _pardiso_spsolve_reuse, sideband_list, assemble_khat_conversion_base, assemble_conversion_matrix_from_base... |
| src/twpa_solver/signal/gain.py | Module; defines db20, db10, gain_db_from_s, complex_to_pair, GainResult | db20, db10, gain_db_from_s, complex_to_pair, GainResult |
| src/twpa_solver/signal/gamma.py | Module; defines synthesize_real_from_positive_harmonics, load_dc_branch_flux, compute_gamma_hat, write_gamma_hat_summary, build_khat | synthesize_real_from_positive_harmonics, load_dc_branch_flux, compute_gamma_hat, write_gamma_hat_summary, build_khat |
| src/twpa_solver/signal/io.py | Module; defines infer_circuit_dir_from_pump_report, PumpSolution, load_pump, csv_header, result_to_csv_row, print_sweep_row, write_outputs | infer_circuit_dir_from_pump_report, PumpSolution, load_pump, csv_header, result_to_csv_row, print_sweep_row... |
| src/twpa_solver/signal/stability.py | Floquet/Hill stability diagnostics on top of the existing gain-solve matrices | SigmaMinEstimate, estimate_sigma_min, sigma_min_at_signal_ghz, sweep_sigma_min, local_minima, ComplexResonance... |
### tests/
