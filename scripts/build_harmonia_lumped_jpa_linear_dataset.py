...
from twpa.io.dataset_builder import build_harmonia_lumped_jpa_linear_dataset
...
def main() -> int:
    ...
    if args.json:
        ...
        print("Built Harmonia lumped JPA linear dataset")
        print("========================================")
