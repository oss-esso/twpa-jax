"""
Build an ML-ready dataset from a Harmonia CircuitIR JTL linear campaign.

Example
-------
python scripts/build_harmonia_jtl_linear_dataset.py
"""
...
from twpa.io.dataset_builder import build_harmonia_jtl_linear_dataset
...
def main() -> int:
    ...
    if args.json:
        ...
        print("Built Harmonia JTL linear dataset")
        print("=================================")
