"""
Build an ML-ready dataset from a linear S-parameter campaign registry.

Example
-------
python scripts/build_linear_sparams_dataset.py ^
  --registry D:/Projects/Thesis/outputs/campaigns/linear_sparams/runs.csv ^
  --output-dir D:/Projects/Thesis/outputs/datasets/linear_sparams_v0
"""
...
def main() -> int:
    ...
    parser.add_argument(
        "--registry",
        type=Path,
        default=_WORKSPACE_ROOT / "outputs" / "campaigns" / "linear_sparams" / "runs.csv",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=_WORKSPACE_ROOT / "outputs" / "datasets" / "linear_sparams_v0",
    )
    ...
    if args.json:
        ...
        print("Built linear S-parameter dataset")
        print("================================")
